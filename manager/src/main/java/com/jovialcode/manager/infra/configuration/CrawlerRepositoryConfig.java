...
@Configuration
@EnableR2dbcRepositories(entityOperationsRef = "crawlerEntityTemplate")
public class CrawlerRepositoryConfig {
    ...
    public ConnectionFactory connectionFactory() {
        ConnectionFactoryOptions options = ConnectionFactoryOptions.builder()
            ...
            .option(ConnectionFactoryOptions.DATABASE, "crawler")
    ...
    public R2dbcEntityOperations entityTemplate(@Qualifier("crawlerConnectionFactory") ConnectionFactory connectionFactory) {
